...
public class ImageProcesser  {
    ...
    private static final char[] charset1 = {'1','2','3','4','5','6','7',' '};   //默认字符素材集
    ...
    public static void main(String[] args) {
        ImageProcesser processer = new  ImageProcesser();
        processer.toBitmapConvert("C:\\Users\\Administrator\\Desktop\\20180118135017.png"); //图片的地址
        processer.saveAsTxt("C:\\Users\\Administrator\\Desktop\\test.txt");//txt文件地址
    }
